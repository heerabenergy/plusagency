<div class="row" id="app">
    ...
    <div class="col-lg-6 offset-lg-3">
        <form id="ajaxForm" action="{{route($updateRoute,$input->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
        ...
        @endif
            ...
            @if ($input->type != 3 && $input->type != 5 && $input->type != 10)
                <div class="form-group">
  ...
  <script>
    var app = new Vue({
      ...
      created() {
        $.get("{{route($optionsRoute, $input->id)}}", (data) => {
