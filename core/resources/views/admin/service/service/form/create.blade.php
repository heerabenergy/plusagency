  ...
  <div class="row" id="app">
      ...
      <div class="card">
        <div class="card-body">
            @if (count($serviceInputs) > 0)
                ...
                @foreach ($serviceInputs as $key => $serviceInput)
                    {{-- input type text --}}
                    @if ($serviceInput->type == 1)
                    <form action="{{route('admin.service.form.inputDelete',$serviceInput->id)}}" method="post">
                        @csrf
                        @method('DELETE')
                        <div class="form-group">
                        <label for="">{{$serviceInput->label}} @if($serviceInput->required == 1) <span>**</span> @elseif($serviceInput->required == 0) (Optional) @endif</label>
                        <div class="row">
                            <div class="col-md-10">
                            <input class="form-control" type="text" name="" value="" placeholder="{{$serviceInput->placeholder}}">
                            </div>
                            <div class="col-md-1">
                            <a class="btn btn-warning btn-md" href="{{route('admin.service.form.inputEdit', $serviceInput->id)}}">
                            ...
                            <button @class([
                                'btn-md btn',
                                'btn-danger' => $serviceInput->active == 0,
                                'btn-success' => $serviceInput->active == 1
                            ]) type="submit">
                                <i @class([
                                    'fa fa-toggle-on' => $serviceInput->active == 1,
                                    'fa fa-toggle-off' => $serviceInput->active == 0
                                ])></i>
                            </button>
                            </div>
                        </div>
                    ...
                    <form action="{{route('admin.service.form.inputDelete',$serviceInput->id)}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <select class="form-control" name="">
                                <option value="" selected disabled>{{$serviceInput->placeholder}}</option>
                                @foreach ($serviceInput->service_input_options as $key => $option)
                            ...
                            <div class="col-md-1">
                            <a class="btn btn-warning btn-md" href="{{route('admin.service.form.inputEdit', $serviceInput->id) . '?language=' . request()->input('language')}}">
                                <i class="fas fa-edit"></i>
                            </a>
                            </div>
                            <div class="col-md-1">
                    ...
                    <form action="{{route('admin.service.form.inputDelete',$serviceInput->id)}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <button @class([
                                ...
                                <i @class([
                                    'fa fa-times' => $serviceInput->active == 1,
                                    'fa fa-check' => $serviceInput->active == 0
                                ])></i>
                            </button>
                            </div>
                        </div>
                    ...
                    <form action="{{route('admin.service.form.inputDelete',$serviceInput->id)}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                            <textarea class="form-control" name="" rows="5" cols="80" placeholder="{{$serviceInput->placeholder}}"></textarea>
                            </div>
                            <div class="col-md-1">
                            <a class="btn btn-warning btn-md" href="{{route('admin.service.form.inputEdit', $serviceInput->id) . '?language=' . request()->input('language')}}">
                                <i class="fas fa-edit"></i>
                            ...
                            <button @class([
                                'btn-md btn',
                                'btn-danger' => $serviceInput->active == 1,
                                'btn-success' => $serviceInput->active == 0
                            ]) type="submit">
                                <i @class([
                                    'fa fa-toggle-on' => $serviceInput->active == 1,
                                    'fa fa-toggle-off' => $serviceInput->active == 0
                    ...
                    <form action="{{route('admin.service.form.inputDelete',$serviceInput->id)}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="text" class="form-control datepicker" autocomplete="off" placeholder="{{$serviceInput->placeholder}}">
                            </div>
                            <div class="col-md-1">
                            <a class="btn btn-warning btn-md" href="{{route('admin.service.form.inputEdit', $serviceInput->id) . '?language=' . request()->input('language')}}">
                                <i class="fas fa-edit"></i>
                    ...
                    <form action="{{route('admin.service.form.inputDelete',$serviceInput->id)}}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <input type="text" class="form-control timepicker" autocomplete="off" placeholder="{{$serviceInput->placeholder}}">
                            </div>
                            <div class="col-md-1">
                            <a class="btn btn-warning btn-md" href="{{route('admin.service.form.inputEdit', $serviceInput->id) . '?language=' . request()->input('language')}}">
                                <i class="fas fa-edit"></i>
    ...
    <div class="col-lg-5">
      <div class="card">
        ...
        <form id="ajaxForm" action="{{route('admin.service.form.store',$service->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
