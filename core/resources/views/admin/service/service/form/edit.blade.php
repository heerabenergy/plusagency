        ...
        <div class="card-body">
            <div class="row" id="app">
                ...
                <div class="col-lg-6 offset-lg-3">
                    <form id="ajaxForm" action="{{route('admin.service.form.inputUpdate',$input->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
...
@section('vuescripts')
  <script>
    var app = new Vue({
      ...
      created() {
        $.get("{{route('admin.service.form.options', $input->id)}}", (data) => {
