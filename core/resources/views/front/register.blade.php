        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    @endif
                            <div class="input-btn">
                                <button aria-label="{{__('Register')}}" type="submit">{{__('Register')}}</button>
                                <p>{{__('Already have an account ?')}} <a aria-label="{{__('Click Here')}}" class="mr-3" href="{{route('user.login')}}">{{__('Click Here')}}</a> {{__('to login')}}.</p>
