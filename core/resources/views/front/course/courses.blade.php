...
@section('content')
          ...
          @foreach ($featured_courses as $featured_course)
            <div class="course-item col-lg-4">
                <div class="course-img">
                    <img data-src="{{ asset('assets/front/img/courses/' . $featured_course->course_image) }}" class="img-fluid lazy" alt="{{__($featured_course->title)}}" >
                    <a aria-label="{{__('Course Details')}}" href="{{ route('course_details', ['slug' => $featured_course->slug]) }}" class="course-overlay">
              ...
              <div class="course-content">
                <h3>
                  <a aria-label="{{__('Course Details')}}" href="{{ route('course_details', ['slug' => $featured_course->slug]) }}">
                ...
                <div class="course-admin-price">
                    <div class="admin">
                      <img src="{{asset('assets/front/img/instructors/' . $featured_course->instructor_image)}}" class="img-fluid" alt="{{__($featured_course->instructor_name)}}">
            ...
            @else
              ...
              <div class="col-md-6 col-sm-12">
                <div class="course-item">
                  <div class="course-img">
                    <img data-src="{{ asset('assets/front/img/courses/' . $course->course_image) }}" class="img-fluid lazy" alt="{{__($course->title)}}" >
                    <a aria-label="{{__('Course Details')}}" href="{{ route('course_details', ['slug' => $course->slug]) }}" class="course-overlay">
                  ...
                  <div class="course-content">
                    <h3>
                      <a aria-label="{{__('Course Details')}}" href="{{ route('course_details', ['slug' => $course->slug]) }}">
                        {{strlen($course->title) > 30 ? mb_substr($course->title, 0, 30, 'utf-8') . '...' : $course->title}}
                      </a>
                    </h3>
                    <div class="course-admin-price">
                      <div class="admin">
                        <img src="{{asset('assets/front/img/instructors/' . $course->instructor_image)}}" class="img-fluid" alt="{{__($course->instructor_name)}}">
  ...
  <form id="searchForm" class="d-none" action="{{ route('courses') }}" method="GET">
    ...
    >
    <button aria-label="{{__('Submit')}}" type="submit" id="submitBtn"></button>
  </form>
  {{-- end of search form --}}
