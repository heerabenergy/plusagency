        ...
        <section class="lawyer_banner banner_v1">
            <div class="hero_slide_v1">
                <div class="single_slider bg_image lazy" data-bg="{{asset('assets/front/img/'.$bs->hero_bg)}}" id="heroHome4" style="background-size: cover;">
                            ...
                            <div class="col-lg-8">
                                <div class="banner_content">
                                    ...
                                    @if (!empty($bs->hero_section_button_url) && !empty($bs->hero_section_button_text))
                                        <a aria-label="{{__($bs->hero_section_button_text)}}" href="{{$bs->hero_section_button_url}}" class="lawyer_btn" data-animation="fadeInUp" data-delay=".3s" style="font-size: {{$be->hero_section_button_text_font_size}}px">{{convertUtf8($bs->hero_section_button_text)}}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="scroll_down">
                        <a aria-label="{{__('Scroll Down')}}" href="#about_v1" class="page_scroll">{{__('Scroll Down')}} <span class="line"></span></a>
                    </div>
                    <div class="line_info_box">
                        <a aria-label="{{__('Email')}}" href="mailto:{{$bs->support_email}}">{{$bs->support_email}}</a>
                    </div>
                </div>
            </div>
        </section>
