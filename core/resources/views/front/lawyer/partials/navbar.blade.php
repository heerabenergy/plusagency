					...
					<div class="site_menu">
						<div class="row align-items-center">
							<div class="col-lg-2 col-sm-12">
								<div class="brand">
									<a aria-label="{{__('Logo')}}" href="{{route('front.index')}}"><img data-src="{{asset('assets/front/img/'.$bs->logo)}}" class="img-fluid lazy" alt="{{__('Logo')}}"></a>
								</div>
							</div>
                            ...
                            @if ($bs->is_quote == 1)
                                <div class="col-lg-2">
                                    <div class="button_box">
                                        <a aria-label="{{__('Consultation')}}" href="{{route('front.quote')}}" class="lawyer_btn">{{__('Consultation')}}</a>
                                    </div>
                                </div>
                            @endif
							<div class="col-sm-12">
