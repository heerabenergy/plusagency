...
@section('content')
                                ...
                                <div class="grid_inner_item">
                                    @if (!empty($scat->image))
                                        <div class="finlance_img">
                                            <img data-src="{{asset('assets/front/img/service_category_icons/'.$scat->image)}}" class="img-fluid lazy" alt="{{__($scat->name)}}">
                                            <div class="service_overlay">
                                                <div class="button_box">
                                                    <a aria-label="{{__($scat->name)}}" href="{{route('front.services', ['category'=>$scat->id])}}" class="more_icon"><i class="fas fa-angle-double-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    <div class="finlance_content">
                                        <h3><a aria-label="{{__($scat->name)}}" href="{{route('front.services', ['category'=>$scat->id])}}">{{convertUtf8($scat->name)}}</a></h3>
                                    </div>
                            ...
                            <div class="grid_item">
                                <div class="grid_inner_item">
                                    @if (!empty($service->main_image))
                                        <div class="finlance_img">
                                            <img data-src="{{asset('assets/front/img/services/' . $service->main_image)}}" class="lazy" alt="{{__($service->title)}}" />
                                            @if($service->details_page_status == 1)
                                                <div class="service_overlay">
                                                    <div class="button_box">
                                                        <a aria-label="{{__($service->title)}}" href="{{route('front.servicedetails', [$service->slug, $service->id])}}" class="more_icon"><i class="fas fa-angle-double-right"></i></a>
                                                    </div>
                                                </div>
                                            @endif
                                        </div>
                                    @endif
                                    <div class="finlance_content">
                                        <h3><a aria-label="{{__($service->title)}}" @if($service->details_page_status == 1) href="{{route('front.servicedetails', [$service->slug, $service->id])}}" @endif>{{convertUtf8($service->title)}}</a></h3>
                                    </div>
                                    <div class="summary text-center mt-2">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="finlance_box_img">
                            <div class="finlance_img">
                                <img data-src="{{asset('assets/front/img/'.$bs->intro_bg)}}" class="img-fluid lazy" alt="{{__('Intro background')}}">
                            </div>
                            <div class="play_box">
                                <a aria-label="{{__('Play Video')}}" href="{{$bs->intro_section_video_link}}" class="play_btn"><i class="fas fa-play"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="finlance_content_box">
                            ...
                            @if (!empty($bs->intro_section_button_url) && !empty($bs->intro_section_button_text))
                                <div class="button_box">
                                    <a aria-label="{{__($bs->intro_section_button_text)}}" href="{{$bs->intro_section_button_url}}" class="finlance_btn" target="_blank">{{convertUtf8($bs->intro_section_button_text)}}</a>
                                </div>
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="finlance_content_box">
                            ...
                            @if (!empty($bs->approach_button_url) && !empty($bs->approach_button_text))
                                <div class="button_box">
                                    <a aria-label="{{__($bs->approach_button_text)}}" href="{{$bs->approach_button_url}}" class="finlance_btn">{{convertUtf8($bs->approach_button_text)}}</a>
                                </div>
                            @endif
                        </div>
                    </div>
        ...
        <section class="finlance_fun finlance_fun_v1 bg_image pt-100 pb-100" style="background-image: url('{{asset('assets/front/img/'.$be->statistics_bg)}}'); background-size:cover; @if($bs->home_version == 'parallax') background-attachment: fixed; @endif" id="statisticsSection">
            <div class="container">
                <div class="row">
            ...
            <div class="container">
                <div class="partner_slide">
                    ...
                    <div class="single_partner">
                        <a aria-label="{{__($partner->name)}}" href="{{$partner->url}}" target="_blank"><img data-src="{{asset('assets/front/img/partners/'.$partner->image)}}" class="img-fluid lazy" alt="Partner Logo"></a>
                    </div>
                    @endforeach
                </div>
            </div>
                ...
                <div class="project_slide project-slick">
                    @foreach ($portfolios as $key => $portfolio)
                        <div class="grid_item">
                            <div class="grid_inner_item">
                                <div class="finlance_img">
                                    <img data-src="{{asset('assets/front/img/portfolios/featured/'.$portfolio->featured_image)}}" class="img-fluid lazy" alt="{{__($portfolio->title)}}">
                                    <div class="project_overlay">
                                        <div class="finlance_content">
                                            <a aria-label="{{__($portfolio->title)}}" href="{{route('front.portfoliodetails', [$portfolio->slug, $portfolio->id])}}" class="more_icon"><i class="fas fa-angle-double-right"></i></a>
                                            <h3><a aria-label="{{__($portfolio->title)}}" href="{{route('front.portfoliodetails', [$portfolio->slug, $portfolio->id])}}">{{strlen($portfolio->title) > 36 ? mb_substr($portfolio->title, 0, 36, 'utf-8') . '...' : $portfolio->title}}</a></h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="testimonial_box">
                            <div class="row align-items-center">
                                <div class="col-lg-5 col-md-5">
                                    <div class="finlance_img">
                                        <img data-src="{{asset('assets/front/img/testimonials/'.$testimonial->image)}}" class="img-fluid lazy" alt="{{__($testimonial->name)}}">
                                    </div>
                                </div>
                                <div class="col-lg-7 col-md-7">
                                    <div class="finlance_content">
                                        <img data-src="{{asset('assets/front/img/quote.png')}}" class="lazy" alt="{{__('Quote')}}">
                ...
                <div class="team_slide team_slick">
                    @foreach ($members as $key => $member)
                        <div class="grid_item">
                            <div class="grid_inner_item">
                                <div class="finlance_img">
                                    <img data-src="{{asset('assets/front/img/members/'.$member->image)}}" class="img-fluid lazy" alt="{{__($member->name)}}">
                                        ...
                                        <div class="finlance_content">
                                            ...
                                            <ul class="social_box">
                                                @if (!empty($member->facebook))
                                                    <li><a aria-label="{{__($member->name)}}" href="{{$member->facebook}}" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                                @endif
                                                @if (!empty($member->twitter))
                                                    <li><a aria-label="{{__($member->name)}}" href="{{$member->twitter}}" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                                @endif
                                                @if (!empty($member->linkedin))
                                                    <li><a aria-label="{{__($member->name)}}" href="{{$member->linkedin}}" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                                                @endif
                                                @if (!empty($member->instagram))
                                                    <li><a aria-label="{{__($member->name)}}" href="{{$member->instagram}}" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    @foreach ($packages as $key => $package)
                        <div class="pricing_box text-center">
                            ...
                            <div class="pricing_button">
                                ...
                                <a aria-label="{{__('Place Order')}}" href="{{route('front.packageorder.index', $package->id)}}" class="finlance_btn">{{__('Place Order')}}</a>
                                @endif
                            </div>
                        </div>
                    @endforeach
        ...
        <section class="finlance_cta cta_v1 main_bg pt-70 pb-70">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4">
                        <div class="button_box">
                            <a aria-label="{{__($bs->cta_section_button_text)}}" href="{{$bs->cta_section_button_url}}" class="finlance_btn">{{convertUtf8($bs->cta_section_button_text)}}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="finlance_blog blog_v1 pt-115 pb-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="section_title">
                            <span>{{$bs->blog_section_title}}</span>
                            <h2>{{$bs->blog_section_subtitle}}</h2>
                            <span class="line-circle"></span>
                        </div>
                    </div>
                </div>
                <div class="blog_slide blog_slick">
                    @foreach ($blogs as $key => $blog)
                        <div class="grid_item">
                            <div class="grid_inner_item">
                                <div class="finlance_img">
                                    <a aria-label="{{__($blog->title)}}" href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}"><img data-src="{{asset('assets/front/img/blogs/'.$blog->main_image)}}" class="img-fluid lazy" alt="Blog Image"></a>
                                    <div class="blog-overlay">
                                        <div class="finlance_content">
                                            ...
                                            @endphp
                                            <div class="post_meta">
                                                <span><i class="far fa-user"></i><a aria-label="{{__('By')}} {{__('Admin')}}" href="#">{{__('By')}} {{__('Admin')}}</a></span>
                                                <span><i class="far fa-calendar-alt"></i><a aria-label="{{__($blogDate)}}" href="#">{{$blogDate}}</a></span>
                                            </div>
                                            <h3 class="post_title"><a aria-label="{{__($blog->title)}}" href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}">{{strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title}}</a></h3>
                                            <p>{!! strlen(strip_tags($blog->content)) > 100 ? mb_substr(strip_tags($blog->content), 0, 100, 'utf-8') . '...' : strip_tags($blog->content) !!}</p>
                                            <a aria-label="{{__('Read More')}}" href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}" class="btn_link">{{__('Read More')}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
