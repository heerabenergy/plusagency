...
<section class="finlance_banner banner_v1">
    <div class="hero_slide_v1">
        ...
        @endphp
        <div class="single_slider bg_image lazy" id="hero-home-5" data-bg="{{asset('assets/front/img/'.$bs->hero_bg)}}" style="background-size: cover;background-color: {{$bgColor}};">
                    ...
                    <div class="col-lg-12">
                        <div class="banner_content text-center">
                            ...
                            @if (!empty($bs->hero_section_button_url) && !empty($bs->hero_section_button_text))
                                <a aria-label="{{__($bs->hero_section_button_text)}}" href="{{$bs->hero_section_button_url}}" class="finlance_btn" data-animation="fadeInUp" data-delay=".4s" style="font-size: {{$be->hero_section_button_text_font_size}}px">{{convertUtf8($bs->hero_section_button_text)}}</a>
                            @endif
                        </div>
                    </div>
                </div>
