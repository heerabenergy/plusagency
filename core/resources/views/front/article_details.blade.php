            ...
            <div class="card">
              ...
              >
                <div class="card-body">
                  ...
                  @if (count($articles) == 0)
                  <ul class="list">
                    <li><a href="#" aria-label="{{__('Articles in this category')}}">{{ '0 ' . __('Articles in this category') }}</a></li>
                  </ul>
                  @else
                  <ul class="list">
                    @foreach ($articles as $article)
                    <li>
                      <a aria-label="{{__('Article')}}" href="{{ route('front.knowledgebase_details', ['slug' => $article->slug]) }}" class="{{$article->id == $details->id ? 'active' : ''}}">
