          ...
          @foreach ($article_categories as $article_category)
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div class="knowledge-box mb-40">
                <div class="title">
                  <h3><a aria-label="{{$article_category->name}}" href="#">{{ $article_category->name }}</a></h3>
                </div>
                @php
                ...
                <ul class="list">
                  @foreach ($articles as $article)
                    <li><a aria-label="{{$article->title}}" href="{{ route('front.knowledgebase_details', ['slug' => $article->slug]) }}">
