<div class="well py-5 text-center bg-light" style="direction: ltr;">
    ...
    <a aria-label="{{__('Click Here')}}" href="{{route('admin.pagebuilder.content', ['type' => 'themeHome', 'theme' => "$be->theme_version", 'language' => $currentLang->code])}}" target="_blank">Click Here</a>
