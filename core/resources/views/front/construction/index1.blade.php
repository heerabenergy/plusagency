                ...
                <div class="col-lg-6">
                    <div class="finlance_box_img">
                        <div class="finlance_img">
                            <img data-src="{{asset('assets/front/img/'.$bs->intro_bg)}}" class="img-fluid lazy" alt="{{__('About Image')}}">
                        </div>
                        <div class="play_box">
                    ...
                    <div class="finlance_content_box">
                        ...
                        @if (!empty($bs->intro_section_button_url) && !empty($bs->intro_section_button_text))
                            <div class="button_box">
                                <a aria-label="{{convertUtf8($bs->intro_section_button_text)}}" href="{{$bs->intro_section_button_url}}" class="finlance_btn">{{convertUtf8($bs->intro_section_button_text)}}</a>
                            </div>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="grid_item">
                            <div class="grid_inner_item">
                                ...
                                <div class="finlance_content">
                                    ...
                                    <a aria-label="{{__('View Services')}}" href="{{route('front.services', ['category'=>$scategory->id])}}" class="btn_link d-inline-block mt-35">{{__('View Services')}}</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
                            ...
                            <div class="grid_inner_item">
                                ...
                                <div class="finlance_content">
                                    ...
                                    @if($service->details_page_status == 1)
                                        <a aria-label="{{__('Read More')}}" href="{{route('front.servicedetails', [$service->slug, $service->id])}}" class="btn_link d-inline-block mt-35">{{__('Read More')}}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="finlance_content_box">
                        ...
                        @if (!empty($bs->approach_button_url) && !empty($bs->approach_button_text))
                            <div class="button_box  wow fadeInUp" data-wow-delay=".4s">
                                <a aria-label="{{convertUtf8($bs->approach_button_text)}}" href="{{$bs->approach_button_url}}" class="finlance_btn">{{convertUtf8($bs->approach_button_text)}}</a>
                            </div>
                        @endif
                    </div>
                </div>
                        ...
                        <div class="grid_inner_item">
                            <div class="finlance_img">
                                ...
                                <div class="overlay_content">
                                    <div class="button_box">
                                        <a aria-label="{{__('View More')}}" href="{{route('front.portfoliodetails', [$portfolio->slug, $portfolio->id])}}" class="finlance_btn">{{__('View More')}}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="finlance_content">
    ...
    <section class="finlance_team team_v1 gray_bg pt-100 pb-75">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="button_box">
                        <a aria-label="{{__('View More Team Members')}}" href="{{route('front.team')}}" class="btn_link">{{__('View More')}}</a>
                    </div>
                </div>
            </div>
            ...
            <div class="blog_slide blog-slick">
                @foreach ($blogs as $key => $blog)
                    <div class="grid_item">
                        <div class="grid_inner_item">
                            <div class="finlance_img">
                                <a aria-label="{{__('Read Blog Post')}}: {{$blog->title}}" href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}"><img data-src="{{asset('assets/front/img/blogs/'.$blog->main_image)}}" class="img-fluid lazy" alt="Blog Image"></a>
                            </div>
                            <div class="finlance_content">
                                <div class="post_meta">
                                    @php
                                    ...
                                    @endphp
                                    <span><i class="far fa-user"></i><a aria-label="{{__('By Admin')}}" href="#">{{__('By')}} {{__('Admin')}}</a></span>
                                    <span><i class="far fa-calendar-alt"></i><a aria-label="{{__('Published on')}} {{$blogDate}}" href="#">{{$blogDate}}</a></span>
                                </div>
                                <h3 class="post_title"><a aria-label="{{__('Read Blog Post')}}: {{$blog->title}}" href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}">{{strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title}}</a></h3>
                                <a aria-label="{{__('Read More about')}} {{$blog->title}}" href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}" class="btn_link">{{__('Read More')}}</a>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="partner_slide">
                @foreach ($partners as $key => $partner)
                    <div class="single_partner">
                        <a aria-label="{{__('Visit Partner')}}: {{$partner->name}}" href="{{$partner->url}}"><img data-src="{{asset('assets/front/img/partners/'.$partner->image)}}" class="img-fluid lazy" alt="Partner Logo"></a>
                    </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="finlance_cta cta_v1 main_bg pt-70 pb-70">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="button_box">
                        <a aria-label="{{convertUtf8($bs->cta_section_button_text)}}" href="{{$bs->cta_section_button_url}}" class="finlance_btn">{{convertUtf8($bs->cta_section_button_text)}}</a>
                    </div>
                </div>
            </div>
        </div>
