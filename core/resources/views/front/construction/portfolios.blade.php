...
@section('content')
<!--    case lists start   -->
<div class="finlance_project project_v1 pt-115 pb-115" id="masonry-portfolio">
  <div class="container">
    @if (serviceCategory())
      <div class="row">
        <div class="col-xl-12">
                  ...
                  <div class="finlance_img">
                    ...
                    <div class="overlay_content">
                      <div class="button_box">
                        <a aria-label="{{__('View More')}}" href="{{route('front.portfoliodetails', [$portfolio->slug])}}" class="finlance_btn">{{__('View More')}}</a>
                      </div>
                    </div>
                  </div>
