                ...
                <div class="shop-sidebar">
                    <div class="shop-box shop-category">
                        ...
                        <div class="category-item">
                            <ul>
                            <li class="{{ request()->input('category_id') == '' ? 'active-search' : '' }}" ><a aria-label="{{__('View All Categories')}}" data-href="0" class="category-id cursor-pointer">{{__('All')}}</a></li>
                                @foreach ($categories as $category)
                                <li class="{{ request()->input('category_id') == $category->id ? 'active-search' : '' }}"><a aria-label="{{__('Filter by Category')}}: {{$category->name}}" data-href="{{$category->id}}" class="category-id cursor-pointer">{{$category->name}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="shop-box shop-tag mt-30">
                        ...
                        <div class="tag-item">
                            <ul>
                                <li class="{{ request()->input('tag') == '' ? 'active-search' : '' }}"><a aria-label="{{__('View All Tags')}}" data-href="" class="tag-id cursor-pointer">{{__('All')}}</a></li>
                                @foreach (explode(',',$be->popular_tags) as $tag)
                                <li class="{{ request()->input('tag') == $tag ? 'active-search' : '' }}"><a aria-label="{{__('Filter by Tag')}}: {{convertUtf8($tag)}}" data-href="{{$tag}}" class="tag-id cursor-pointer">{{convertUtf8($tag)}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                  ...
                  <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="shop-item">
                        ...
                        <div class="shop-content text-center">
                            ...
                            @endif
                            <a aria-label="{{__('View Product')}}: {{convertUtf8($product->title)}}" class="{{$bex->product_rating_system == 0 || $bex->catalog_mode == 1 ? 'mt-3' : ''}}" href="{{route('front.product.details',$product->slug)}}">
