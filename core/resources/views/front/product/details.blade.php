            ...
            <div class="col-lg-6">
                <div class="product-item-slide ">
                    ...
                    <div class="item pt-30">
                        <a aria-label="{{__('View Product Image')}}: {{$product->title}}" class="image-popup" href="{{asset('assets/front/img/product/sliders/'.$image->image)}}"><img src="{{asset('assets/front/img/product/sliders/'.$image->image)}}" alt="{{__($product->title)}}"></a>
                    </div>
                    @endforeach
                </div>
                <div class="product-details-slide-item mt-30">
                    <ul class="d-flex">
                        @foreach ($product->product_images as $image)
                        <li><img src="{{asset('assets/front/img/product/sliders/'.$image->image)}}" alt="{{__($product->title)}}"></li>
                        @endforeach
                    </ul>
                </div>
            </div>
                ...
                <div class="product-details-content ml-60 mt-30">
                    ...
                    <div class="product-social-icon social-link a2a_kit a2a_kit_size_32">
                        <ul class="social-share">
                            <li>
                                <a aria-label="{{__('Share on Facebook')}}" class="facebook a2a_button_facebook" href="">
                                  <i class="fab fa-facebook-f"></i>
                                </a>
                              </li>
                                <li>
                                    <a aria-label="{{__('Share on Twitter')}}" class="twitter a2a_button_twitter" href="">
                                      <i class="fab fa-twitter"></i>
                                    </a>
                                </li>
                                <li>
                                    <a aria-label="{{__('Share on LinkedIn')}}" class="linkedin a2a_button_linkedin" href="">
                                      <i class="fab fa-linkedin-in"></i>
                                    </a>
                                </li>
                                <li>
                                    <a aria-label="{{__('Share on Pinterest')}}" class="pinterest a2a_button_pinterest" href="">
                                      <i class="fab fa-pinterest"></i>
                                    </a>
                                </li>
                                <li>

                                <a aria-label="{{__('Share on More Platforms')}}" class="a2a_dd plus" href="https://www.addtoany.com/share">
                    ...
                    <div class="product-details-tags">
                        <ul>
                            ...
                            <li><span>{{__('Category')}}:</span> <a aria-label="{{__('View Products in Category')}}: {{$product->category ? convertUtf8($product->category->name) : ''}}" href="{{route('front.product').'?category_id='.$product->category_id}}">{{$product->category ? convertUtf8($product->category->name) : ''}}</a> </li>
                            @endif
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-11">
                <div class="shop-tab-area">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item">
                        <a aria-label="{{__('View Product Description')}}" class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">{{__('Description')}}</a>
                        </li>
                        @if ($bex->product_rating_system == 1 && $bex->catalog_mode == 0)
                        <li class="nav-item">
                            <a aria-label="{{__('View Product Reviews')}}" class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">{{__('Reviews')}} ({{count($reviews)}})</a>
                        </li>
                        @endif
                    </ul>
                            ...
                            <div class="shop-review-area">
                                ...
                                @if (count($reviews) > 0)
                                    ...
                                    <div class="shop-review-user">
                                        @if (strpos($review->user->photo, 'facebook') !== false || strpos($review->user->photo, 'google'))
                                            <img class="lazy" data-src="{{$review->user->photo ? $review->user->photo : asset('assets/front/img/user/profile.jpg')}}" alt="{{__('User image')}}" width="60">
                                        @else
                                            <img class="lazy" data-src="{{$review->user->photo ? asset('assets/front/img/user/'.$review->user->photo) : ''}}" alt="{{__('User image')}}" width="60">
                                        @endif
                                        <ul>
                                            <div class="rate">
                                ...
                                @endif
                                        ...
                                        <form class="mt-5" action="{{route('product.review.submit')}}" method="POST">@csrf
                                            ...
                                            <div class="input-box">
                                                ...
                                                <ul class="review-value review-1">
                                                    <li><a aria-label="{{__('Rate 1 Star')}}" class="cursor-pointer" data-href="1"><i class="far fa-star"></i></a></li>
                                                </ul>
                                                <ul class="review-value review-2">
                                                    <li><a aria-label="{{__('Rate 2 Stars')}}" class="cursor-pointer" data-href="2"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 2 Stars')}}" class="cursor-pointer" data-href="2"><i class="far fa-star"></i></a></li>
                                                </ul>
                                                <ul class="review-value review-3">
                                                    <li><a aria-label="{{__('Rate 3 Stars')}}" class="cursor-pointer" data-href="3"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 3 Stars')}}" class="cursor-pointer" data-href="3"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 3 Stars')}}" class="cursor-pointer" data-href="3"><i class="far fa-star"></i></a></li>
                                                </ul>
                                                <ul class="review-value review-4">
                                                    <li><a aria-label="{{__('Rate 4 Stars')}}" class="cursor-pointer" data-href="4"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 4 Stars')}}" class="cursor-pointer" data-href="4"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 4 Stars')}}" class="cursor-pointer" data-href="4"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 4 Stars')}}" class="cursor-pointer" data-href="4"><i class="far fa-star"></i></a></li>
                                                </ul>
                                                <ul class="review-value review-5">
                                                    <li><a aria-label="{{__('Rate 5 Stars')}}" class="cursor-pointer" data-href="5"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 5 Stars')}}" class="cursor-pointer" data-href="5"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 5 Stars')}}" class="cursor-pointer" data-href="5"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 5 Stars')}}" class="cursor-pointer" data-href="5"><i class="far fa-star"></i></a></li>
                                                    <li><a aria-label="{{__('Rate 5 Stars')}}" class="cursor-pointer" data-href="5"><i class="far fa-star"></i></a></li>
                                            ...
                                            <div class="input-btn mt-3">
                                                <button aria-label="{{__('Submit')}}" type="submit">{{__('Submit')}}</button>
                                            </div>
                                        </form>
                                    </div>
                                    @endif
                                    ...
                                    <div class="review-login mt-5">
                                        <a aria-label="{{__('Login to Leave Rating')}}" class="boxed-btn d-inline-block mr-2" href="{{route('user.login')}}">{{__('Login')}}</a> {{__('to leave a rating')}}
                                    </div>
                                    @endif
                            </div>
                        </div>
             ...
             @foreach ($related_product as $product)
                 <div class="shop-item">
                    ...
                    <div class="shop-content text-center {{$bex->catalog_mode == 1 ? 'pt-3' : ''}}">
                        ...
                        @endif
                        <a aria-label="{{__('View Product')}}: {{convertUtf8($product->title)}}" class="{{$bex->product_rating_system == 0 ? 'mt-3' : ''}}" href="{{route('front.product.details',$product->slug)}}">{{convertUtf8($product->title)}}</a> <br>
