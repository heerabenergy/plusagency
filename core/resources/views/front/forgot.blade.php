                ...
                <div class="login-content">
                    ...
                    <form  action="{{route('user-forgot-submit')}}" method="POST">
                        ...
                        <div class="input-btn mt-4">
                            <button aria-label="{{__('Send Mail')}}" type="submit">{{__('Send Mail')}}</button>
                            <p class="d-inline-block float-right"><a aria-label="{{__('Login Now')}}" href="{{route('user.login')}}">{{__('Login Now')}}</a></p>
                        </div>
                    </form>
                </div>
            </div>
