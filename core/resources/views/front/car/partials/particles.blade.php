    ...
    <section class="finlance_banner banner_v1">
        <div class="hero_slide_v1">
            <div class="single_slider bg_image lazy" id="particles-js" style="background-size: cover;">
                <div class="bg_overlay lazy" data-bg="{{asset('assets/front/img/'.$bs->hero_bg)}}" style="background-color: #{{$be->hero_overlay_color}};opacity: {{$be->hero_overlay_opacity}};"></div>
                <div class="container">
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="banner_content">
                                ...
                                @if (!empty($bs->hero_section_button_url) && !empty($bs->hero_section_button_text))
                                    <a aria-label="{{convertUtf8($bs->hero_section_button_text)}}" href="{{$bs->hero_section_button_url}}" class="finlance_btn" data-animation="fadeInUp" data-delay=".4s" style="font-size: {{$be->hero_section_button_text_font_size}}px">{{convertUtf8($bs->hero_section_button_text)}}</a>
                                @endif
                            </div>
                        </div>
                    </div>
