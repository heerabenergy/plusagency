                                    ...
                                    <div class="col-lg-8">
                                        <div class="banner_content">
                                            ...
                                            @if (!empty($slider->button_url) && !empty($slider->button_text))
                                                <a aria-label="{{$slider->button_text}}" href="{{$slider->button_url}}" class="finlance_btn" data-animation="fadeInUp" data-delay=".4s" style="font-size: {{$slider->button_text_font_size}}px">{{$slider->button_text}}</a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
