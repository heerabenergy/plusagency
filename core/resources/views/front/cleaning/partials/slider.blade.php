                                ...
                                <div class="col-xl-6 col-lg-8">
                                    <div class="hero-content">
                                        ...
                                        @if (!empty($slider->button_url) && !empty($slider->button_text))
                                            <a aria-label="{{convertUtf8($slider->button_text)}}" href="{{$slider->button_url}}" class="main-btn hero-btn" style="font-size: {{$slider->button_text_font_size}}px" data-animation="fadeInUp" data-delay=".4s">{{convertUtf8($slider->button_text)}}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
