...
<head>
  ...
  <!-- base color change -->
  <link
    href="{{ url('/') }}/assets/front/css/logistic-base-color.php?color={{ $bs->base_color }}&color1={{ $bs->secondary_base_color }}"
    rel="stylesheet">
...
<body @if ($rtl == 1) dir="rtl" @endif>
  ...
  <a aria-label="{{__('Announcement')}}" class="announcement-banner" href="{{ asset('assets/front/img/' . $bs->announcement) }}"></a>
          ...
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-12">
              <div class="widget_box about_widget">
                <img data-src="{{ asset('assets/front/img/' . $bs->footer_logo) }}" class="img-fluid lazy"
                  alt="{{__('Footer logo')}}">
                <p>
                  @if (strlen(convertUtf8($bs->footer_text)) > 194)
                    {{ substr(convertUtf8($bs->footer_text), 0, 194) }}<span
                      style="display: none;">{{ substr(convertUtf8($bs->footer_text), 194) }}</span>
              ...
              <div class="widget_box newsletter_box">
                ...
                <form id="footerSubscribeForm" action="{{ route('front.subscribe') }}" method="post">
                  ...
                  <div class="form_group">
                    ...
                    <button aria-label="{{__('Subscribe')}}" class="logistics_btn" type="submit">{{ __('Subscribe') }}</button>
                  </div>
                </form>
              </div>
            </div>
