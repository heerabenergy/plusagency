                ...
                <div class="col-lg-6">
                    <div class="logistics_content_box">
                        ...
                        <div class="button_box">
                            <a aria-label="{{__($bs->intro_section_button_text)}}" href="{{$bs->intro_section_button_url}}" class="logistics_btn">{{convertUtf8($bs->intro_section_button_text)}}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6">
                    <div class="logistics_content_box">
                        ...
                        @if (!empty($bs->approach_button_url) && !empty($bs->approach_button_text))
                            <div class="button_box">
                                <a aria-label="{{__($bs->approach_button_text)}}" href="{{$bs->approach_button_url}}" class="logistics_btn">{{convertUtf8($bs->approach_button_text)}}</a>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="testimonial_slide">
                @foreach ($testimonials as $key => $testimonial)
                    <div class="testimonial_box d-lg-flex align-items-lg-center">
                        <div class="logistics_img">
                            <img data-src="{{asset('assets/front/img/testimonials/'.$testimonial->image)}}" class="img-fluid lazy" alt="{{__($testimonial->name)}}" width="100%">
                        </div>
                        <div class="logistics_content">
                        ...
                        <div class="grid_inner_item">
                            <div class="logistics_img">
                                ...
                                <div class="overlay_content">
                                    <div class="button_box">
                                        <a aria-label="{{__('View More')}}" href="{{route('front.portfoliodetails', [$portfolio->slug, $portfolio->id])}}" class="logistics_btn">{{__('View More')}}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="logistics_content">
                    ...
                    <div class="pricing_box text-center">
                        ...
                        <div class="pricing_button">
                            @if ($package->order_status == 1)
                                <a aria-label="{{__('Place Order')}}" href="{{route('front.packageorder.index', $package->id)}}" class="logistics_btn">{{__('Place Order')}}</a>
                            @endif
                        </div>
                    </div>
                @endforeach
    ...
    <section class="logistics_team team_v1 gray_bg pt-100 pb-75">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4">
                    <div class="button_box">
                        <a aria-label="{{__('View More')}}" href="{{route('front.team')}}" class="btn_link">{{__('View More')}}</a>
                    </div>
                </div>
            </div>
    ...
    <section class="logistics_cta cta_v1 main_bg pt-70 pb-70">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3">
                    <div class="button_box">
                        <a aria-label="{{__($bs->cta_section_button_text)}}" href="{{$bs->cta_section_button_url}}" class="logistics_btn">{{convertUtf8($bs->cta_section_button_text)}}</a>
                    </div>
                </div>
            </div>
        </div>
