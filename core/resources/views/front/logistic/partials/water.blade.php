                        ...
                        <div class="col-lg-12">
                            <div class="banner_content">
                                ...
                                @if (!empty($bs->hero_section_button_url) && !empty($bs->hero_section_button_text))
                                    <a aria-label="{{__($bs->hero_section_button_text)}}" href="{{$bs->hero_section_button_url}}" class="logistics_btn" data-animation="fadeInUp" data-delay=".3s" style="font-size: {{$be->hero_section_button_text_font_size}}px">{{convertUtf8($bs->hero_section_button_text)}}</a>
                                @endif
                            </div>
                        </div>
                    </div>
