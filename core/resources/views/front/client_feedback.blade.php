              ...
              <div class="row">
                  ...
                  <div class="form_group">
                    <div class="rating-box">
                      <ul class="feedback-rating rating-1">
                        <li>
                          <a aria-label="{{__('Rating 1')}}" class="cursor-pointer" data-ratingVal="1"><i class="far fa-star"></i></a>
                        </li>
                      </ul>
                      <ul class="feedback-rating rating-2">
                        <li>
                          <a aria-label="{{__('Rating 2')}}" class="cursor-pointer" data-ratingVal="2"><i class="far fa-star"></i></a>
                        </li>
                        <li>
                          <a aria-label="{{__('Rating 2')}}" class="cursor-pointer" data-ratingVal="2"><i class="far fa-star"></i></a>
                        </li>
                      ...
                      <ul class="feedback-rating rating-3">
                        <li>
                          <a aria-label="{{__('Rating 3')}}" class="cursor-pointer" data-ratingVal="3"><i class="far fa-star"></i></a>
                        </li>
                        <li>
                          <a aria-label="{{__('Rating 3')}}" class="cursor-pointer" data-ratingVal="3"><i class="far fa-star"></i></a>
                        </li>
                      ...
                      <ul class="feedback-rating rating-4">
                        <li>
                          <a aria-label="{{__('Rating 4')}}" class="cursor-pointer" data-ratingVal="4"><i class="far fa-star"></i></a>
                        </li>
                        <li>
                          <a aria-label="{{__('Rating 4')}}" class="cursor-pointer" data-ratingVal="4"><i class="far fa-star"></i></a>
                        </li>
                      ...
                      <ul class="feedback-rating rating-5">
                        <li>
                          <a aria-label="{{__('Rating 5')}}" class="cursor-pointer" data-ratingVal="5"><i class="far fa-star"></i></a>
                        </li>
                        <li>
                          <a aria-label="{{__('Rating 5')}}"      class="cursor-pointer" data-ratingVal="5"><i class="far fa-star"></i></a>
                        </li>
                ...
                <div class="col-lg-12">
                  <div class="form_group text-center">
                    <button aria-label="{{__('Submit')}}" class="main-btn btn base-bg">{{ __('Submit') }}</button>
                  </div>
                </div>
              </div>
            </form>
