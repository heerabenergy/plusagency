                            ...
                            <div class="causes-box mb-40">
                                ...
                                <div class="causes-content">
                                    ...
                                    <div class="content-info">
                                        <h3><a aria-label="{{$cause->title}}" href="{{route('front.cause_details', [$cause->slug])}}">{{strlen($cause->title) > 30 ? mb_substr($cause->title, 0, 30, 'utf-8') . '...' : $cause->title}}</a></h3>
                                        ...
                                        <a aria-label="{{__('Read More')}}" href="{{route('front.cause_details', [$cause->slug])}}" class="readmore-btn"><span>{{__('Read More')}}</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
