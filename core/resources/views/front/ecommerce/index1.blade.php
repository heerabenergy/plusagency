        ...
        <section class="plus-categories pt-105 pb-100">
            <div class="custom-container">
                ...
                <div class="categories-slide">
                    ...
                    <a aria-label="{{__('View Category')}}: {{$category->name}}" href="{{route('front.product', ['category_id' => $category->id])}}" class="categories-item">
                        <div class="cat-img">
                            <img src="{{asset('assets/front/img/product/categories/' . $category->image)}}" alt="{{__($category->name)}}">
                        </div>
                    ...
                    <div id="cat1" class="tab-pane active">
                        <div class="featured-slide">
                            ...
                            @foreach ($fproducts as $product)
                                <div class="shop-item">
                                    <a aria-label="{{__('View Product')}}: {{$product->title}}" class="shop-img" href="{{route('front.product.details',$product->slug)}}">
                                    ...
                                    <div class="shop-info">
                                        ...
                                        @endif
                                        <h3><a aria-label="{{__('View Product')}}: {{$product->title}}" href="{{route('front.product.details',$product->slug)}}">{{strlen($product->title) > 40 ? mb_substr($product->title,0,40,'utf-8') . '...' : $product->title}}</a></h3>
                        ...
                        @foreach ($blogs as $key => $blog)
                            <div class="blog-item mb-40">
                                <div class="post-thumb">
                                    ...
                                    <a aria-label="{{__('View Blog Category')}}: {{!empty($blog->bcategory) ? $blog->bcategory->name : ''}}" href="#" class="cat">{{!empty($blog->bcategory) ? $blog->bcategory->name : ''}}</a>
                                </div>
                                <div class="entry-content">
                                    <h3 class="title"><a aria-label="{{$blog->title}}" href="{{route('front.blogdetails', [$blog->slug, $blog->id])}}">{{strlen($blog->title) > 40 ? mb_substr($blog->title, 0, 40, 'utf-8') . '...' : $blog->title}}</a></h3>
                                    <div class="post-meta">
                                        <ul>
                                            @php
                                            ...
                                            @endphp
                                            <li><span><a aria-label="{{$blogDate}}" href="#">{{$blogDate}}</a></span></li>
                ...
                <div class="sponsor-wrapper pt-60 pb-65">
                    <div class="sponsor-slide">
                        ...
                        <div class="sponsor-item">
                            <a aria-label="{{__('Partner')}}" href="{{$partner->url}}" target="_blank"><img data-src="{{asset('assets/front/img/partners/'.$partner->image)}}" class="lazy" alt="Partner Logo"></a>
                        </div>
                        @endforeach
                    </div>
                </div>
