...
<li class="menu-item menu-item-has-children static mega-dropdown"><a aria-label="{{__($link['text'])}}" href="{{$href}}">{{$link["text"]}}</a>
    <ul class="mega-menu">
        <li class="mega-wrap">
            <div class="row">
                @if ($catAvailable)
                            ...
                            <div class="widget widget-categories">
                                <ul class="widget-link">
                                    ...
                                    @foreach ($megaMenus as $mCatId => $mItemIds)
                                        ...
                                        @endphp
                                        <li><a aria-label="{{__('View')}} {{$mcat->name}}" href="{{$catUrl}}" data-tabid="#megaTab{{$link["type"]}}{{$mcat->id}}">{{$mcat->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                        ...
                        @foreach ($megaMenus as $mCatId => $mItemIds)
                            ...
                            <div class="sidebar-main-wrapper">
                                <div class="mega-row mega-tab" id="megaTab{{$link["type"]}}{{$mCatId}}">
                                    <h4 class="title"><a aria-label="{{__('View')}} {{$mcat->name}}" href="{{$catUrl}}">{{$mcat->name}}</a></h4>
                                    ...
                                    <div class="row">
                                        @foreach ($mItemIds as $mItemId)
                                            ...
                                            <div class="col-lg-3 col-md-6">
                                                <div class="box-item">
                                                    <div class="box-img">
                                                        <a aria-label="{{__('View')}} {{$mItem->title}}" href="{{$detailsUrl}}" class="d-block">
                                                            <img class="lazy" data-src="{{$imgSrc}}" alt="Image" style="width: 100%;">
                                                        </a>
                                                    </div>
                                                    <div class="box-info">
                                                        <h4><a aria-label="{{__('View')}} {{$mItem->title}}" href="{{$detailsUrl}}">{{strlen($mItem->title) > 30 ? mb_substr($mItem->title,0,30,'utf-8') . '...' : $mItem->title}}</a></h4>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
