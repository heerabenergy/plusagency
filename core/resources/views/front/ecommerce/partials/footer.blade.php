                            ...
                            <div class="widget widget-catgories">
                                ...
                                <ul class="link">
                                    @foreach ($ulinks as $key => $ulink)
                                      <li><a aria-label="{{__('View')}} {{$ulink->name}}" href="{{$ulink->url}}">{{$ulink->name}}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="widget about-widget">
                                    ...
                                    <p class="ip">
                                        ...
                                        @foreach ($mails as $mail)
                                            <a aria-label="{{__('Email')}}" href="mailto:{{$mail}}" class="d-inline-block">{{$mail}}</a>
                                            @if (!$loop->last)
                                                ,
                                            @endif
                                        @endforeach
                                    ...
                                    <p class="ip"><i class="fas fa-mobile-alt"></i>
                                        @foreach ($phones as $phone)
                                            <a aria-label="{{__('Phone')}}" href="tel:{{$phone}}">{{$phone}}</a>
                                            @if (!$loop->last)
                                                ,
                                            @endif
                                        @endforeach
