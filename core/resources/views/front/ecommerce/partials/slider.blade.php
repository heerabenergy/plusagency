                        ...
                        <div class="col-lg-7">
                            <div class="hero-content">
                                ...
                                @if (!empty($slider->button_url) && !empty($slider->button_text))
                                    <a aria-label="{{__($slider->button_text)}}" href="{{$slider->button_url}}" style="font-size: {{$slider->button_text_font_size}}px" class="main-btn">{{$slider->button_text}}<i class="fas fa-long-arrow-alt-right"></i></a>
                                @endif
                            </div>
                        </div>
                    </div>
