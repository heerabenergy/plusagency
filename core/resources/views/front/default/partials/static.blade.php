      ...
      <div class="hero-txt">
         <div class="row">
            <div class="col-12">
               ...
               <a aria-label="{{__($bs->hero_section_button_text)}}" href="{{$bs->hero_section_button_url}}" class="hero-boxed-btn" target="_blank">{{convertUtf8($bs->hero_section_button_text)}}</a>
               @endif
            </div>
         </div>
      </div>
