...
<li class="mega-dropdown d-none d-lg-inline-block">
    <a aria-label="{{__($link['text'])}}" class="dropbtn" href="{{$href}}">{{$link["text"]}} <i class="fas fa-angle-down"></i></a>
                ...
                @if ($catAvailable)
                    @foreach ($megaMenus as $mCatId => $mItemIds)
                        ...
                        <div class="mega-tab" id="megaTab{{$link["type"]}}{{$mCatId}}">
                            <h3 class="category">
                                <a aria-label="{{__('View')}} {{$mcat->name}}" href="{{$catUrl}}">{{$mcat->name}}</a>
                            </h3>
                            <div class="row">
                                @foreach ($mItemIds as $mItemId)
                                    ...
                                    <div class="col-lg-3">
                                        <div class="single-item">
                                            ...
                                            <div class="title">
                                                <a aria-label="{{__('View')}} {{$mItem->title}}" href="{{$detailsUrl}}">{{strlen($mItem->title) > 30 ? mb_substr($mItem->title,0,30,'utf-8') . '...' : $mItem->title}}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
