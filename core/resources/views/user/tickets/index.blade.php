                    ...
                    <div class="col-lg-12">
                        <div class="user-profile-details">
                            <div class="account-info">
                                <div class="title">
                                    <h4>{{__('My Tickets')}}</h4>
                                    <a aria-label="{{__('Submit Ticket')}}" href="{{route('user-ticket-create')}}" class="btn btn-primary btn-sm border-0"><i class="fas fa-plus"></i> {{__('Submit Ticket')}}</a>
                                </div>
                                <div class="main-info">
                                            ...
                                            <tbody>
                                                @if($tickets)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a aria-label="{{__('Messages')}}" href="{{route('user-ticket-messages',$ticket->ticket_number)}}" class="btn btn-primary border-0 btn-sm">
