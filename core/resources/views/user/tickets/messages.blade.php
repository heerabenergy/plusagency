                        ...
                        <div class="user-profile-details">
                            <div class="account-info">
                                <div class="title">
                                    ...
                                    <a aria-label="{{__('Back to List')}}" href="{{route('user-tickets')}}" class="btn btn-primary btn-sm border-0"><i class="fas fa-angle-left"></i> {{__('Back to List')}}</a>
                                </div>
                                ...
                                <div class="summary">
                                    ...
                                    @if($ticket->zip_file)
                                    <a aria-label="{{__('Download Attachment')}}" href="{{asset('assets/front/user-suppor-file/'.$ticket->zip_file)}}" download="support.zip" class="btn btn-primary"><i class="fas fa-download"></i> Download Attachment</a>
                                    @endif
                                </div>
                                    ...
                                    <div class="message-lists">
                                        ...
                                        <div class="single-message">
                                            <div class="user-details">
                                                <div class="user-img">
                                                    <img src="{{$admin->image ? asset('assets/admin/img/propics/'.$admin->image) : asset('assets/admin/img/propics/blank_user.jpg')}}" alt="user profile image">
                                                </div>
                                                <div class="user-infos">
                                                    ...
                                                    @if($reply->file)
                                                        <a aria-label="{{__('Download')}}" href="{{asset('assets/front/user-suppor-file/'.$reply->file)}}" download="support.zip" class="reply-download-btn"><i class="fas fa-download"></i> {{__('Download')}}</a>
                                                        @endif
                                                </div>
                                            </div>
                                                ...
                                                <div class="user-details">
                                                    <div class="user-img rounded-circle">
                                                        @if (strpos($user->photo, 'facebook') !== false || strpos($user->photo, 'google'))
                                                            <img class="rounded-circle" src="{{$user->photo ? $user->photo : asset('assets/front/img/user/profile.jpg')}}" alt="user profile image">
                                                        @else
                                                            <img class="rounded-circle" src="{{$user->photo ? asset('assets/front/img/user/'.$user->photo) : ''}}" alt="user profile image">
                                                        @endif
                                                    </div>
                                                    <div class="user-infos">
                               ...
                               <div class="reply-section">
                                ...
                                <form action="{{route('user.ticket.reply',$ticket->id)}}" method="POST" enctype="multipart/form-data" class="reply-form">
                                    ...
                                    <div class="form-element">
                                        <button aria-label="{{__('Reply')}}" type="submit" class="btn btn-success"><i class="fas fa-retweet"></i> {{__('Reply')}}</button>
                                    </div>
                                </form>
                            </div>
                               @endif
