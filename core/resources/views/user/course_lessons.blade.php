                    ...
                    <div class="card-body">
                      <ul>
                        ...
                        @foreach ($lessons as $lesson)
                          <li><a aria-label="{{__($lesson->name)}}" href="#" class="videoLesson" data-video_file="{{$lesson->video_file}}" data-video_link="{{$lesson->video_link}}"><i class="fas fa-play"></i> {{__($lesson->name)}} <span class="duration">{{$lesson->duration}}</span></a></li>
                        @endforeach
                      </ul>
                    </div>
                  </div>
