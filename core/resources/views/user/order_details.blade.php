                            ...
                            <div class="user-profile-details">
                                <div class="order-details">
                                        ...
                                        <div class="order-info-area">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-4 print-btn">
                                                    <div class="prinit">
                                                        <a aria-label="{{__('Download Invoice')}}" href="{{asset('assets/front/invoices/product/' . $data->invoice_number)}}" download="invoice.pdf" id="print-click" class="btn"><i class="fas fa-print"></i>{{__('Download Invoice')}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <td>
                                                                ...
                                                                @if ($product->type == 'digital' && $data->payment_status == 'Completed')
                                                                    ...
                                                                    @elseif (!empty($product->download_link))
                                                                        <a aria-label="{{__('Download')}}" style="font-size: 12px;" href="{{$product->download_link}}" target="_blank" class="digital-donwload-btn btn btn-primary btn-sm border-0 base-bg text-uppercase">{{__('Download')}}</a>
                                                                    @endif
                                                                @endif
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="edit-account-info">
                                        <a aria-label="{{__('Back')}}" href="{{ URL::previous() }}" class="btn btn-primary">{{__('Back')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
