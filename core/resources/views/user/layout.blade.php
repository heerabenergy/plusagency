            ...
            <div class="col-lg-6 {{$rtl == 1 ? 'text-left' : 'text-right'}}">
              <ul class="social-links">
                @foreach ($socials as $key => $social)
                  <li>
                    <a aria-label="{{__($social->name)}}" target="_blank" href="{{$social->url}}">
              ...
              <div class="language">
                <a aria-label="{{__($currentLang->name)}}" class="language-btn" href="#">
                  <i class="flaticon-worldwide"></i> {{convertUtf8($currentLang->name)}}
                </a>
                <ul class="language-dropdown">
                  @foreach ($langs as $key => $lang)
                    <li><a aria-label="{{__($lang->name)}}" href='{{ route('changeLanguage', $lang->code) }}'>{{convertUtf8($lang->name)}}</a></li>
                  @endforeach
                </ul>
              </div>
              @endif
              ...
              @auth
                <div class="language dashboard">
                    <a aria-label="{{__('Dashboard')}}" class="language-btn" href="#">
