                ...
                <div class="row mb-5">
                    <div class="col-lg-12">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <a aria-label="{{__('Product Orders')}}" class="card card-box box-1 mb-4 product" href="{{route('user-orders')}}">
                                    <div class="card-info">
                            ...
                            @if ($bex->is_course == 1)
                            <div class="col-md-6">
                                <a aria-label="{{__('Enrolled Courses')}}" class="card card-box box-2 course" href="{{route('user.course_orders')}}">
                                    <div class="card-info">
                            ...
                            <div class="col-md-6 mb-4">
                                <a aria-label="{{__('Event Bookings')}}" class="card card-box box-3 event" href="{{route('user-events')}}">
                                    <div class="card-info">
                            ...
                            @if ($bex->is_ticket == 1)
                            <div class="col-md-6 mb-4">
                                <a aria-label="{{__('Support Tickets')}}" class="card card-box box-1 support" href="{{route('user-tickets')}}">
                                    <div class="card-info">
                                            ...
                                            <table id="ordersTable" class="dataTables_wrapper dt-responsive table-striped dt-bootstrap4" style="width:100%">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>{{$order->order_number}}</td>
                                                            ...
                                                            <td><a aria-label="{{__('Details')}}" href="{{route('user-orders-details',$order->id)}}" class="btn">{{__('Details')}}</a></td>
                                                        </tr>
                                                        @endforeach
                                                        @else
