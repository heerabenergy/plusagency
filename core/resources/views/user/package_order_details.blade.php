                                        ...
                                        <div class="order-info-area">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-4 print-btn">
                                                    <div class="prinit">
                                                        <a aria-label="{{__('Download Invoice')}}" href="{{asset('assets/front/invoices/' . $data->invoice)}}" download="invoice.pdf" id="print-click" class="btn"><i class="fas fa-print"></i>{{__('Download Invoice')}}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                                    ...
                                                                    @if ($field['type'] == 5)
                                                                        <li class="mb-2">
                                                                            <p><span>{{str_replace("_"," ",$key)}}:</span>
                                                                                <a aria-label="{{__('Download')}}" href="{{asset('assets/front/files/' . $field['value'])}}" class="btn btn-primary btn-sm" download="{{$key . ".zip"}}">Download</a>
                                                                            </p>
                                                                        </li>
                                                                    @else
