...
Route::group(['middleware' => 'setlang'], function () {
  ...
  Route::group(["as" => "front."], function () {
    ...
    // Service Routes
    Route::get('service-form/{slug}', [FrontendController::class, 'serviceform'])->name('serviceform')->middleware('auth');
    Route::post('sendservice/{slug}', [FrontendController::class, 'sendservice'])->name('sendservice')->middleware('auth');
...
Route::get('/course/payment/complete', 'Payment\Course\PayuMoneyController@complete')->name('course.payumoney.complete');
  ...
  Route::group(['middleware' => ['setlang']], function () {
    ...
    foreach ($wdPermalinks as $pl) {
      ...
      if ($type == 'packages') {
        ...
        $action = [FrontendController::class,'blogs'];
        ...
        $action = [AdminLoginController::class,'login'];
